...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="editcategory.php?editid=<?php echo $row['ID'];?>">Edit</a> |  <a href="manage-cakecategory.php?del=<?php echo $row['ID'];?>" style="color:red;" onclick="return confirm('Do you really want to delete the category?');">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
