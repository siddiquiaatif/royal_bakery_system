...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="edit-cake.php?editid=<?php echo $row['ID'];?>">Edit</a>  | 
                    <a href="manage-cake.php?delfood=<?php echo $row['ID'];?>" style="color:red;" onclick="return confirm('Do you really want to delete the food item?');">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
